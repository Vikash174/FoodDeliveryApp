...
const WhatOnYourMind = (props) => {
  ...
  return (
    <div className="border-b-2 border-b-gray-100">
      ...
      <div className="h-42 flex  overflow-y-auto overflow-hidden">
        {dishesList.map((dish) => {
...
export const Title = (props) => {
  const { title } = props;
  return <span className="text-2xl font-bold m-2 p-2">{title}</span>;
};
...
export const NextPrevBtn = () => {
  return (
    <div className="p-2">
      <button className=" p-2 m-2 bg-gray-100 rounded-3xl">
        <svg
          width="17"
          height="17"
          viewBox="0 0 17 17"
      ...
      <button className="p-2 m-2 bg-gray-300 rounded-3xl">
        <svg
          width="17"
          height="17"
          viewBox="0 0 17 17"
